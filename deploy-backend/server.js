...
app.use(cors({
    origin: function (origin, callback) {
        ...
        else if (origin === 'https://nextgenerationaustria.at') {
            callback(null, true);
        } else {
...
app.use('/forum', forumRoutes);  // Changed from /api/forum to /forum
app.use('/polls', pollsRoutes);  // Changed from /api/polls to /polls
