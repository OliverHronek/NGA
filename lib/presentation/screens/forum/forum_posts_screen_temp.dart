...
class _CreatePostScreenState extends State<CreatePostScreen> {
  ...
  Future<void> _createPost() async {
    print('=== DEBUG: _createPost() gestartet ===');
    print('Form Key State: ${_formKey.currentState}');
    
    if (!_formKey.currentState!.validate()) {
      print('DEBUG: Formular-Validierung fehlgeschlagen');
      return;
    }
    
    print('DEBUG: Formular-Validierung erfolgreich');
    print('DEBUG: categoryId = ${widget.categoryId}');
    print('DEBUG: title = "${_titleController.text.trim()}"');
    print('DEBUG: title length = ${_titleController.text.trim().length}');
    print('DEBUG: content = "${_contentController.text.trim()}"');
    print('DEBUG: content length = ${_contentController.text.trim().length}');
    ...
    print('DEBUG: CreatePostRequest erstellt');
    print('DEBUG: postRequest.categoryId = ${postRequest.categoryId}');
    print('DEBUG: postRequest.title = "${postRequest.title}"');
    print('DEBUG: postRequest.content = "${postRequest.content}"');
    print('DEBUG: postRequest.userId = ${postRequest.userId}');

    final forumProvider = Provider.of<ForumProvider>(context, listen: false);
    print('DEBUG: ForumProvider erhalten, rufe createPost auf...');
    
    final success = await forumProvider.createPost(postRequest);
    
    print('DEBUG: forumProvider.createPost() Ergebnis: $success');
    if (!success) {
      print('DEBUG: Fehler aus ForumProvider: ${forumProvider.error}');
    }
